      ...
      <div className="main">
        <div className="d-flex flex-column d-lg-flex flex-lg-row my-5 text-center">
          <div className="align-self-center order-1 order-lg-0 order-md-1 order-sm-1 pt-sm-3 pt-md-3 pt-3 ">
            <h1 className="text-light fs-1 text-uppercase mx-5">
            ...
            <p className="mx-5 px-3">
              ...
              you. <span className="text-light fw-bold">Even No Gas Fees.</span>
            </p>
        ...
        <div className="d-flex flex-column d-lg-flex flex-lg-row my-5 text-center">
          <div>
            <img
              src={ManImage}
              alt="programmer"
              className="object-fit-cover man-image"
            />
          </div>
          <div>
            <h2 className="text-light fw-bold">About Us</h2>
            <h3 className="fw-light fs-4 px-3 mx-3">
            ...
            <div className="d-flex flex-column d-lg-flex flex-lg-row  d-md-flex d-sm-flex px-5 m-3 gy-3">
            ...
            <div className="d-flex flex-column d-lg-flex flex-lg-row px-5 m-3">
